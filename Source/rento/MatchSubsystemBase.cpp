...
// =============================================================================
// per-match 宿主基类实现（ADR-0001 四 override 骨架）
// 规范依据：ADR-0001、control-manifest Foundation Layer §宿主与生命周期
// =============================================================================
...
void UMatchSubsystemBase::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	// 示例（由 story-002 填入）：
	//   UGameClockSubsystem* Clock = Collection.InitializeDependency<UGameClockSubsystem>();
	//
	// 约束（ADR-0001）：
